        ...
        <section className="about-section" id="sobre">
          ...
          <div className="about-text">
            ...
            <div className="social-links" aria-label="Redes sociais">
              ...
              <a className="social-button social-whatsapp social-static" href="https://w.app/arthurteodoro" target="_blank" rel="noreferrer" aria-label="WhatsApp">
              ...
              <a className="social-button social-email social-static" href="https://mail.google.com/mail/?view=cm&fs=1&to=arthurteodoro.pro@gmail.com" target="_blank" rel="noreferrer" aria-label="E-mail">
                <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M2.25 4.5A2.25 2.25 0 0 1 4.5 2.25h15a2.25 2.25 0 0 1 2.25 2.25v15a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25v-15Zm2.25 0v.511l7.5 5.625 7.5-5.625V4.5h-15Zm15 2.639-6.825 5.119a1.125 1.125 0 0 1-1.35 0L4.5 7.139V19.5h15V7.139Z" /></svg>
              </a>
            </div>
          </div>
        </section>
